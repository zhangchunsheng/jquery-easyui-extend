...
$.ajax({url:_51.url,async:_51.async,dataType:"json",success:function(_52){
_49(_50,_52);
...
$.fn.combobox.defaults={async:false,width:"auto",listWidth:null,listHeight:null,valueField:"value",textField:"text",editable:true,url:null,onLoadSuccess:function(){
...
},beforePageText:"当前页",afterPageText:"总页{pages}",displayMsg:"显示{from}到{to},共{total}条记录"};
})(jQuery);
(function($){
function _1a9(node){
node.each(function(){
...
$.ajax({type:"post",async:opts.async,url:opts.url,data:_260,dataType:"json",success:function(data){
...
$.fn.tree.defaults={async:true,url:null,animate:false,onLoadSuccess:function(){
},onLoadError:function(){
